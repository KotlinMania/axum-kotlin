...
This file is the quick-reference operating contract for axum-kotlin. The longer
...
axum-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`axum`](https://crates.io/crates/axum). Upstream Rust is the behavioral oracle while the
