...
kotlin {
    ...
    macosArm64 {
        binaries.framework { baseName = "Axum"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Axum"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Axum"
        flattenPackage = "io.github.kotlinmania.axum"
    }

    android {
        namespace = "io.github.kotlinmania.axum"
        compileSdk = 34
        minSdk = 24
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                // implementation("io.github.kotlinmania:tokio-tungstenite-kotlin:0.1.1") // Not published
                // implementation("io.github.kotlinmania:tracing-kotlin:0.1.1") // Not published
            }
        }
        val commonTest by getting {
            dependencies {
                ...
                // implementation("io.github.kotlinmania:uuid-kotlin:0.1.1") // Not published
            }
        }
...
mavenPublishing {
    ...
    coordinates(group.toString(), "axum-kotlin", version.toString())

    pom {
        name.set("axum-kotlin")
        description.set("Kotlin Multiplatform port of tokio-rs/axum - HTTP routing and request handling library that focuses on ergonomics and modularity")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/axum-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/axum-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/axum-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/axum-kotlin.git")
        }
    }
}
