...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Axum.swiftmodule/`
...
//      `import Axum` above would fail at compile time.
//
//   2. The static archive `libAxum.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Axum" }` and
//      `flattenPackage = "io.github.kotlinmania.axum"` configuration in
...
final class AxumExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Axum swift module imported cleanly")
    }
}
